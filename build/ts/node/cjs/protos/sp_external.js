...
// @generated message type with reflection information, may provide speed optimized methods
class GetPipelineHistoryRequest$Type extends runtime_5.MessageType {
    constructor() {
 ...
 */
exports.GetPipelineHistoryRequest = new GetPipelineHistoryRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetPipelineHistoryResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("protos.GetPipelineHistoryResponse", [
            { no: 1, name: "entries", kind: "map", K: 5 /*ScalarType.INT32*/, V: { kind: "message", T: () => sp_pipeline_1.Pipeline } }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case 1:
                    ...
                    break;
                case 2:
                    val = sp_pipeline_1.Pipeline.internalBinaryRead(reader, reader.uint32(), options);
                    break;
                default: throw new globalThis.Error("unknown map entry field for field protos.GetPipelineHistoryResponse.entries");
            }
        }
        map[key !== null && key !== void 0 ? key : 0] = val !== null && val !== void 0 ? val : sp_pipeline_1.Pipeline.create();
    }
    internalBinaryWrite(message, writer, options) {
        ...
        for (let k of Object.keys(message.entries)) {
            ...
            writer.tag(2, runtime_1.WireType.LengthDelimited).fork();
            sp_pipeline_1.Pipeline.internalBinaryWrite(message.entries[k], writer, options);
            writer.join().join();
        }
        let u = options.writeUnknownFields;
        if (u !== false)
 ...
 */
exports.GetPipelineHistoryResponse = new GetPipelineHistoryResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
exports.External = new runtime_rpc_1.ServiceType("protos.External", [
    ...
    { name: "GetPipelineHistory", options: {}, I: exports.GetPipelineHistoryRequest, O: exports.GetPipelineHistoryResponse },
