...
// @generated message type with reflection information, may provide speed optimized methods
class GetPipelineHistoryRequest$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class GetPipelineHistoryResponse$Type extends MessageType {
    constructor() {
    ...
    binaryReadMap1(map, reader, options) {
        ...
        map[key !== null && key !== void 0 ? key : 0] = val !== null && val !== void 0 ? val : Pipeline.create();
    }
    internalBinaryWrite(message, writer, options) {
        ...
        for (let k of Object.keys(message.entries)) {
            ...
            writer.tag(2, WireType.LengthDelimited).fork();
            Pipeline.internalBinaryWrite(message.entries[k], writer, options);
            writer.join().join();
        }
        let u = options.writeUnknownFields;
        if (u !== false)
