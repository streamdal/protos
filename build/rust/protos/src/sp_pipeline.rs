...
pub struct Pipeline {
    ...
    // @@protoc_insertion_point(field:protos.Pipeline.version)
    pub version: i32,
    ///  Created at timestamp (set by server)
    // @@protoc_insertion_point(field:protos.Pipeline.created_at)
    pub created_at: i64,
    ///  Modified by server on each update
    // @@protoc_insertion_point(field:protos.Pipeline.updated_at)
    pub updated_at: i64,
    // special fields
...
impl Pipeline {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "version",
            |m: &Pipeline| { &m.version },
            |m: &mut Pipeline| { &mut m.version },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "created_at",
            |m: &Pipeline| { &m.created_at },
            |m: &mut Pipeline| { &mut m.created_at },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "updated_at",
            |m: &Pipeline| { &m.updated_at },
            |m: &mut Pipeline| { &mut m.updated_at },
        ));
...
impl ::protobuf::Message for Pipeline {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.created_at != 0 {
            my_size += ::protobuf::rt::int64_size(5, self.created_at);
        }
        if self.updated_at != 0 {
            my_size += ::protobuf::rt::int64_size(6, self.updated_at);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.created_at != 0 {
            os.write_int64(5, self.created_at)?;
        }
        if self.updated_at != 0 {
            os.write_int64(6, self.updated_at)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\x03(\x0b2\x14.protos.PipelineStepR\x05steps\x12\x18\n\x07version\
    \x18\x04\x20\x01(\x05R\x07version\x12\x1d\n\ncreated_at\x18\x05\x20\x01(\
    \x03R\tcreatedAt\x12\x1d\n\nupdated_at\x18\x06\x20\x01(\x03R\tupdatedAt\
    \"\xd5\x06\n\x0cPipelineStep\x12\x12\n\x04name\x18\x01\x20\x01(\tR\x04na\
    me\x12<\n\non_success\x18\x02\x20\x03(\x0e2\x1d.protos.PipelineStepCondi\
    tionR\tonSuccess\x12<\n\non_failure\x18\x03\x20\x03(\x0e2\x1d.protos.Pip\
    elineStepConditionR\tonFailure\x12<\n\tdetective\x18\xe8\x07\x20\x01(\
    ...
    \x01(\x0b2\x1b.protos.steps.ValidJSONStepH\0R\tvalidJson\x12\x1e\n\x08_w\
    asm_id\x18\x90N\x20\x01(\tH\x01R\x06WasmId\x88\x01\x01\x12$\n\x0b_wasm_b\
    ytes\x18\x91N\x20\x01(\x0cH\x02R\tWasmBytes\x88\x01\x01\x12*\n\x0e_wasm_\
    function\x18\x92N\x20\x01(\tH\x03R\x0cWasmFunction\x88\x01\x01B\x06\n\
    \x04stepB\x0b\n\tX_wasm_idB\x0e\n\x0cX_wasm_bytesB\x11\n\x0fX_wasm_funct\
    ion*\xb0\x01\n\x15PipelineStepCondition\x12!\n\x1dPIPELINE_STEP_CONDITIO\
    N_UNSET\x10\0\x12)\n%PIPELINE_STEP_CONDITION_ABORT_CURRENT\x10\x01\x12\"\
    \n\x1ePIPELINE_STEP_CONDITION_NOTIFY\x10\x02\x12%\n!PIPELINE_STEP_CONDIT\
    ION_ABORT_ALL\x10\x03B-Z+github.com/streamdal/protos/build/go/protosJ\
    ...
    \x02\x08\x0b\x12\x03\x0e\0B\n\xc8\x01\n\x02\x04\0\x12\x04\x13\0&\x01\x1a\
    \xbb\x01\x20Pipeline\x20is\x20a\x20structure\x20that\x20holds\x20one\x20\
    or\x20more\x20pipeline\x20steps.\x20This\x20structure\n\x20is\x20intende\
    d\x20to\x20be\x20immutable;\x20clients\x20are\x20expected\x20to\x20gener\
    ate\x20WASMRequest's\n\x20that\x20contain\x20a\x20pipeline\x20step.\n\n\
    \n\n\x03\x04\0\x01\x12\x03\x13\x08\x10\n\x9f\x01\n\x04\x04\0\x02\0\x12\
    \x03\x16\x02\x10\x1a\x91\x01\x20ID\x20should\x20NOT\x20be\x20set\x20by\
    \x20external\x20gRPC\x20client\x20on\x20CreatePipelineRequest\x20-\x20it\
    \n\x20will\x20be\x20ignored;\x20it\x20_does_\x20need\x20to\x20be\x20set\
    \x20on\x20UpdatePipelineRequest.\n\n\x0c\n\x05\x04\0\x02\0\x05\x12\x03\
    \x16\x02\x08\n\x0c\n\x05\x04\0\x02\0\x01\x12\x03\x16\t\x0b\n\x0c\n\x05\
    \x04\0\x02\0\x03\x12\x03\x16\x0e\x0f\n-\n\x04\x04\0\x02\x01\x12\x03\x19\
    ...
    \x04\x04\0\x02\x02\x12\x03\x1c\x02\"\x1a\x1e\x20One\x20or\x20more\x20ste\
    ps\x20to\x20execute\n\n\x0c\n\x05\x04\0\x02\x02\x04\x12\x03\x1c\x02\n\n\
    \x0c\n\x05\x04\0\x02\x02\x06\x12\x03\x1c\x0b\x17\n\x0c\n\x05\x04\0\x02\
    \x02\x01\x12\x03\x1c\x18\x1d\n\x0c\n\x05\x04\0\x02\x02\x03\x12\x03\x1c\
    \x20!\n3\n\x04\x04\0\x02\x03\x12\x03\x1f\x02\x14\x1a&\x20Incremented\x20\
    by\x20server\x20on\x20each\x20update\n\n\x0c\n\x05\x04\0\x02\x03\x05\x12\
    \x03\x1f\x02\x07\n\x0c\n\x05\x04\0\x02\x03\x01\x12\x03\x1f\x08\x0f\n\x0c\
    \n\x05\x04\0\x02\x03\x03\x12\x03\x1f\x12\x13\n3\n\x04\x04\0\x02\x04\x12\
    \x03\"\x02\x17\x1a&\x20Created\x20at\x20timestamp\x20(set\x20by\x20serve\
    r)\n\n\x0c\n\x05\x04\0\x02\x04\x05\x12\x03\"\x02\x07\n\x0c\n\x05\x04\0\
    \x02\x04\x01\x12\x03\"\x08\x12\n\x0c\n\x05\x04\0\x02\x04\x03\x12\x03\"\
    \x15\x16\n0\n\x04\x04\0\x02\x05\x12\x03%\x02\x17\x1a#\x20Modified\x20by\
    \x20server\x20on\x20each\x20update\n\n\x0c\n\x05\x04\0\x02\x05\x05\x12\
    \x03%\x02\x07\n\x0c\n\x05\x04\0\x02\x05\x01\x12\x03%\x08\x12\n\x0c\n\x05\
    \x04\0\x02\x05\x03\x12\x03%\x15\x16\n\xd2\x01\n\x02\x05\0\x12\x04+\06\
    \x01\x1a\xc5\x01\x20A\x20condition\x20defines\x20how\x20the\x20SDK\x20sh\
    ould\x20handle\x20a\x20step\x20response\x20--\x20should\x20it\n\x20conti\
    nue\x20executing\x20the\x20pipeline,\x20should\x20it\x20abort,\x20should\
    \x20it\x20notify\x20the\x20server?\n\x20Each\x20step\x20can\x20have\x20m\
    ultiple\x20conditions.\n\n\n\n\x03\x05\0\x01\x12\x03+\x05\x1a\n\x0b\n\
    \x04\x05\0\x02\0\x12\x03,\x02$\n\x0c\n\x05\x05\0\x02\0\x01\x12\x03,\x02\
    \x1f\n\x0c\n\x05\x05\0\x02\0\x02\x12\x03,\"#\n^\n\x04\x05\0\x02\x01\x12\
    \x03/\x02,\x1aQ\x20Abort\x20executing\x20the\x20current\x20pipeline\x20A\
    ND\x20continue\x20executing\x20any\x20other\x20pipelines\n\n\x0c\n\x05\
    \x05\0\x02\x01\x01\x12\x03/\x02'\n\x0c\n\x05\x05\0\x02\x01\x02\x12\x03/*\
    +\n9\n\x04\x05\0\x02\x02\x12\x032\x02%\x1a,\x20Notify\x20the\x20server\
    \x20about\x20the\x20step\x20condition\n\n\x0c\n\x05\x05\0\x02\x02\x01\
    \x12\x032\x02\x20\n\x0c\n\x05\x05\0\x02\x02\x02\x12\x032#$\n,\n\x04\x05\
    \0\x02\x03\x12\x035\x02(\x1a\x1f\x20Abort\x20executing\x20ALL\x20pipelin\
    es\n\n\x0c\n\x05\x05\0\x02\x03\x01\x12\x035\x02#\n\x0c\n\x05\x05\0\x02\
    \x03\x02\x12\x035&'\n=\n\x02\x04\x01\x12\x049\0W\x01\x1a1\x20A\x20pipeli\
    ne\x20step\x20is\x20a\x20single\x20step\x20in\x20a\x20pipeline.\n\n\n\n\
    ...
    \x01\x12\x03>\x020\x1aN\x20SDKs\x20should\x20read\x20this\x20when\x20WAS\
    M\x20returns\x20success\x20to\x20determine\x20what\x20to\x20do\x20next\n\
    \n\x0c\n\x05\x04\x01\x02\x01\x04\x12\x03>\x02\n\n\x0c\n\x05\x04\x01\x02\
    \x01\x06\x12\x03>\x0b\x20\n\x0c\n\x05\x04\x01\x02\x01\x01\x12\x03>!+\n\
    \x0c\n\x05\x04\x01\x02\x01\x03\x12\x03>./\n[\n\x04\x04\x01\x02\x02\x12\
    \x03A\x021\x1aN\x20SDKs\x20should\x20read\x20this\x20when\x20WASM\x20ret\
    ...
    \x04\x01\x02\x02\x03\x12\x03A/0\n\x0c\n\x04\x04\x01\x08\0\x12\x04C\x02M\
    \x03\n\x0c\n\x05\x04\x01\x08\0\x01\x12\x03C\x08\x0c\n\x0b\n\x04\x04\x01\
    \x02\x03\x12\x03D\x04)\n\x0c\n\x05\x04\x01\x02\x03\x06\x12\x03D\x04\x17\
    \n\x0c\n\x05\x04\x01\x02\x03\x01\x12\x03D\x18!\n\x0c\n\x05\x04\x01\x02\
    \x03\x03\x12\x03D$(\n\x0b\n\x04\x04\x01\x02\x04\x12\x03E\x04)\n\x0c\n\
    \x05\x04\x01\x02\x04\x06\x12\x03E\x04\x17\n\x0c\n\x05\x04\x01\x02\x04\
    \x01\x12\x03E\x18!\n\x0c\n\x05\x04\x01\x02\x04\x03\x12\x03E$(\n\x0b\n\
    \x04\x04\x01\x02\x05\x12\x03F\x04#\n\x0c\n\x05\x04\x01\x02\x05\x06\x12\
    \x03F\x04\x14\n\x0c\n\x05\x04\x01\x02\x05\x01\x12\x03F\x15\x1b\n\x0c\n\
    \x05\x04\x01\x02\x05\x03\x12\x03F\x1e\"\n\x0b\n\x04\x04\x01\x02\x06\x12\
    \x03G\x04#\n\x0c\n\x05\x04\x01\x02\x06\x06\x12\x03G\x04\x14\n\x0c\n\x05\
    \x04\x01\x02\x06\x01\x12\x03G\x15\x1b\n\x0c\n\x05\x04\x01\x02\x06\x03\
    \x12\x03G\x1e\"\n\x0b\n\x04\x04\x01\x02\x07\x12\x03H\x04#\n\x0c\n\x05\
    \x04\x01\x02\x07\x06\x12\x03H\x04\x14\n\x0c\n\x05\x04\x01\x02\x07\x01\
    \x12\x03H\x15\x1b\n\x0c\n\x05\x04\x01\x02\x07\x03\x12\x03H\x1e\"\n\x0b\n\
    \x04\x04\x01\x02\x08\x12\x03I\x04.\n\x0c\n\x05\x04\x01\x02\x08\x06\x12\
    \x03I\x04\x19\n\x0c\n\x05\x04\x01\x02\x08\x01\x12\x03I\x1a&\n\x0c\n\x05\
    \x04\x01\x02\x08\x03\x12\x03I)-\n\x0b\n\x04\x04\x01\x02\t\x12\x03J\x04\
    \x1b\n\x0c\n\x05\x04\x01\x02\t\x06\x12\x03J\x04\x10\n\x0c\n\x05\x04\x01\
    \x02\t\x01\x12\x03J\x11\x13\n\x0c\n\x05\x04\x01\x02\t\x03\x12\x03J\x16\
    \x1a\n\x0b\n\x04\x04\x01\x02\n\x12\x03K\x04.\n\x0c\n\x05\x04\x01\x02\n\
    \x06\x12\x03K\x04\x19\n\x0c\n\x05\x04\x01\x02\n\x01\x12\x03K\x1a&\n\x0c\
    \n\x05\x04\x01\x02\n\x03\x12\x03K)-\n\x0b\n\x04\x04\x01\x02\x0b\x12\x03L\
    \x04*\n\x0c\n\x05\x04\x01\x02\x0b\x06\x12\x03L\x04\x17\n\x0c\n\x05\x04\
    \x01\x02\x0b\x01\x12\x03L\x18\"\n\x0c\n\x05\x04\x01\x02\x0b\x03\x12\x03L\
    %)\n}\n\x04\x04\x01\x02\x0c\x12\x03P\x02#\x1a9\x20ID\x20is\x20a\x20uuid(\
    sha256(_wasm_bytes))\x20that\x20is\x20set\x20by\x20server\n\"5\x20protol\
    int:disable:this\x20FIELD_NAMES_LOWER_SNAKE_CASE\n\n\x0c\n\x05\x04\x01\
    \x02\x0c\x04\x12\x03P\x02\n\n\x0c\n\x05\x04\x01\x02\x0c\x05\x12\x03P\x0b\
    \x11\n\x0c\n\x05\x04\x01\x02\x0c\x01\x12\x03P\x12\x1a\n\x0c\n\x05\x04\
    \x01\x02\x0c\x03\x12\x03P\x1d\"\ng\n\x04\x04\x01\x02\r\x12\x03S\x02%\x1a\
    #\x20WASM\x20module\x20bytes\x20(set\x20by\x20server)\n\"5\x20protolint:\
    disable:this\x20FIELD_NAMES_LOWER_SNAKE_CASE\n\n\x0c\n\x05\x04\x01\x02\r\
    \x04\x12\x03S\x02\n\n\x0c\n\x05\x04\x01\x02\r\x05\x12\x03S\x0b\x10\n\x0c\
    \n\x05\x04\x01\x02\r\x01\x12\x03S\x11\x1c\n\x0c\n\x05\x04\x01\x02\r\x03\
    \x12\x03S\x1f$\ns\n\x04\x04\x01\x02\x0e\x12\x03V\x02)\x1a/\x20WASM\x20fu\
    nction\x20name\x20to\x20execute\x20(set\x20by\x20server)\n\"5\x20protoli\
    nt:disable:this\x20FIELD_NAMES_LOWER_SNAKE_CASE\n\n\x0c\n\x05\x04\x01\
    \x02\x0e\x04\x12\x03V\x02\n\n\x0c\n\x05\x04\x01\x02\x0e\x05\x12\x03V\x0b\
    \x11\n\x0c\n\x05\x04\x01\x02\x0e\x01\x12\x03V\x12\x20\n\x0c\n\x05\x04\
    \x01\x02\x0e\x03\x12\x03V#(b\x06proto3\
";
